...
import { DEFAULT_GIT_DIFFS_CONFIG } from "../../packages/feature-git/src/model/local-target"
import { DEFAULT_PULL_REQUEST_CONFIG } from "../../packages/feature-git/src/model/pr/config"
import * as git from "../../packages/feature-git/src/services/git"
...
import * as local from "../../packages/feature-git/src/services/local-target"
import * as issues from "../../packages/feature-git/src/storage/issue/config"
import * as diffs from "../../packages/feature-git/src/storage/local/config"
import * as prs from "../../packages/feature-git/src/storage/pr/config"
import { useGitConfiguration } from "../../packages/feature-git/src/ui/config/useGitConfiguration"

...
- Acompanhar agentes reconhecidos exclusivamente em **Agentes**, com um loader animado enquanto trabalham. **Terminais** mostra os demais terminais. As pastas e divisões originais são preservadas, e o terminal volta para Terminais quando o agente encerra. Com a Master Key aberta, os primeiros nove agentes e terminais visíveis mostram teclas sequenciais `[1]`, `[2]`, … `[9]`; digite uma delas para ativá-lo.

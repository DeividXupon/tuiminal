...
| `[V]` / `[H]` | Dividir para o lado / abaixo |
...
As linhas recém-detectadas mantêm o fundo azul enquanto permanecerem no patch.
Só as novas linhas recebem um brilho breve; edições posteriores somam outras linhas azuis.

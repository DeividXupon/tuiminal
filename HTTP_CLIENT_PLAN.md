...
> Status: proposta técnica viva. Este documento descreve direção futura, não o
> comportamento já disponível. Deve ser revisto quando protótipos, testes de TUI
> ou limitações do Bun/OpenTUI contradisserem alguma decisão.
>
...
| --- | --- | --- | --- |
| Tuiminal | worktree local em 2026-09-04 | Bun, OpenTUI, React | [`HttpWorkspace.tsx`](./src/features/http/HttpWorkspace.tsx), [`http.ts`](./src/features/http/services/http.ts), [`http.test.ts`](./tests/http.test.ts) |

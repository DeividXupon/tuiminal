...
export function demoIssueDetails(item: IssueSummary): IssueDetails {
  return {
    ...
    comments: [
      ...
      {
        id: `${item.identity.nodeId}-comment-3`,
        author: { login: "bia" },
        body: `↳ ${item.identity.url}#issuecomment-2\n\n@deivid A resposta agora aparece dentro da conversa.`,
        createdAt: "2026-09-06T12:01:00Z",
        updatedAt: "2026-09-06T12:01:00Z",
        url: `${item.identity.url}#issuecomment-3`,
        reactionCount: 0,
      },
    ],
    commentPage: { totalCount: 3, hasNextPage: false, endCursor: null, partial: false },
